...
import {shopping_cart } from '../services/images'
            ...
            <h5 className='cart-modal-title fw-5 fs-15 font-manrope text-center'>Recenlty Added Products</h5>
            {
                (carts?.length > 0) ? (
                    <div className='cart-modal-list grid'>
                        ...
                        <div className='text-capitalize view-cart-btn bg-orange text-white fs-15 font-manrope text-center'>view my shopping cart</div>
                    </div>) : (
